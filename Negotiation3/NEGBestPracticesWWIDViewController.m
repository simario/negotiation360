...
- (void)configureView
{
    ...
    for (int i = 0; i < len; i++) {
        ...
        str = [NSString stringWithFormat:@"%@<li class='list-group-item' style='font-size: 14px; text-align: left'><strong>Negotiation Name:</strong> %@<br><strong>Date:</strong> %@<br><strong>Agreement Reached:</strong> %@</li>", str, name, dateString, reachAgreement, nil];
        str = [NSString stringWithFormat:@"%@<li class='list-group-item' style='font-size: 14px; text-align: left'>&ldquo; %@ &rdquo;</li>", str, q11, nil];
        str = [NSString stringWithFormat:@"%@<li class='list-group-item' style='font-size: 14px; text-align: left'>&ldquo; %@ &rdquo;</li>", str, q12, nil];
