...
-(NSMutableDictionary *)getType:(id)detailItem {
    ...
    NSMutableDictionary *type2 = [self createType:@"type2"
                                          ...
                                          string2:@"Understanding other people’s interests is important to negotiation success. So is self-advocacy. Expanding the pie is great, but you deserve a fair share of it, as well.  When you review the skill-building tips in this app, start with the section on asserting your own interests."];
    ...
    NSMutableDictionary *type3 = [self createType:@"type3"
                                          ...
                                          string2:@"Even if most of your negotiations are done by phone, email, or Skype, good relational skills can make the difference between impasse and a satisfactory agreement. When you review the skill-building tips in this app, start with the interpersonal factors to further enhance your effectiveness on this important dimension."];
