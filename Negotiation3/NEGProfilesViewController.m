...
@implementation NEGProfilesViewController
...
- (void)configureView
{
    ...
    if (self.detailItem) {
        ...
        NSString *htmlFile = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"profiles" ofType:@"html" ]];
